...
if (empty($tapelkd))
	...
	{
	//query
	$qjw = mysql_query("SELECT jadwal.*, jadwal.kd AS jkd, m_guru_prog_pddkn.*, m_guru.*, m_prog_pddkn.*, ".
							"m_kelas.*, m_keahlian.*, m_ruang.*, m_hari.*, m_jam.* ".
							...
							"m_ruang.ruang, m_prog_pddkn.prog_pddkn, m_hari.no, m_jam.jam ASC");
