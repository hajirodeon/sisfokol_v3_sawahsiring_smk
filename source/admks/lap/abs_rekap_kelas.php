...
for ($i=1;$i<=12;$i++)
	...
	if ($i<=6) //bulan juli sampai desember
		...
		echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&keakd='.$keakd.'&kelkd='.$kelkd.'&rukd='.$rukd.''.
...
if (empty($tapelkd))
	...
	if ($count != 0)
		...
		<table width="700" border="0" cellspacing="0" cellpadding="3">
	  	<tr>
	    <td width="200">
		[<a href="abs_rekap_kelas_pdf.php?tapelkd='.$tapelkd.'&keakd='.$keakd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&ubln='.$ubln.'&uthn='.$uthn.'" target="_blank"><img src="'.$sumber.'/img/pdf.gif" width="16" height="16" border="0"></a>]
		</td>
