...
if (empty($tapelkd))
	...
	{
	//query
	$qjw = mysql_query("SELECT jadwal.*, jadwal.kd AS jkd, m_guru_prog_pddkn.*, m_guru.*, ".
							"m_prog_pddkn.*, m_kelas.*, m_ruang.*, m_hari.*, m_jam.*, m_keahlian.* ".
							"FROM jadwal, m_guru_prog_pddkn, m_guru, m_prog_pddkn, ".
							"m_kelas, m_ruang, m_hari, m_jam, m_keahlian ".
							...
							"ORDER BY m_keahlian.bidang ASC, m_kelas.no ASC, ".
							"m_ruang.ruang ASC, m_prog_pddkn.prog_pddkn ASC, ".
