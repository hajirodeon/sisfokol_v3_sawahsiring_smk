...
if (empty($tapelkd))
	...
	<tr>
	<td>[<a href="u_siswa_spp_pdf.php?tapelkd='.$tapelkd.'&keakd='.$keakd.'&kelkd='.$kelkd.'&rukd='.$rukd.'" target="_blank"><img src="'.$sumber.'/img/pdf.gif" width="16" height="16" border="0"></a>]
	</td>
