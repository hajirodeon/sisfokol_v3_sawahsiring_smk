...
if (empty($tapelkd))
	...
	if ($count != 0)
		...
		<tr>
		<td>[<a href="u_siswa_gedung_pdf.php?tapelkd='.$tapelkd.'&keakd='.$keakd.'&kelkd='.$kelkd.'&rukd='.$rukd.'" target="_blank"><img src="'.$sumber.'/img/pdf.gif" width="16" height="16" border="0"></a>]
		</td>
