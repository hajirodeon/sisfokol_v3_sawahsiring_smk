...
$ke = "$filenya?tapelkd=$tapelkd&keakd=$keakd&kelkd=$kelkd&rukd=$rukd&swkd=$swkd&page=$page";
...
do
	...
	echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&keakd='.$keakd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&swkd='.$sw_kd.'">'.$sw_nis.'. '.$sw_nm.'</option>';
	}
