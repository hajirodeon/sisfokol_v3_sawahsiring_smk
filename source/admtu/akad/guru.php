...
$ke = "$filenya?tapelkd=$tapelkd&keakd=$keakd&kelkd=$kelkd&page=$page";
...
if ($_POST['btnTBH'])
	...
	if (empty($pegawai))
		...
		if ($tcc != 0)
			...
			{
			//query
			mysql_query("INSERT INTO m_guru(kd, kd_tapel, kd_keahlian, kd_kelas, kd_pegawai) VALUES ".
							"('$x', '$tapelkd', '$keakd', '$kelkd', '$pegawai')");
