...
if ($_POST['btnTBH'])
	...
	if ((empty($pegawai)) OR (empty($ruang)))
		...
		if ($tcc != 0)
			...
			{
			//query
			mysql_query("INSERT INTO m_walikelas(kd, kd_tapel, kd_keahlian, kd_kelas, kd_pegawai, kd_ruang) VALUES ".
							"('$x', '$tapelkd', '$keakd', '$kelkd', '$pegawai', '$ruang')");
...
$keax_bid = balikin2($rowkeax['bidang']);
...
do
	...
	$kea_bid = balikin2($rowkea['bidang']);
