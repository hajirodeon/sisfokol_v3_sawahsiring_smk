...
if (empty($tapelkd))
	...
	$target = "$filenya?tapelkd=$tapelkd&keakd=$keakd&kelkd=$kelkd";
	...
	if ($count != 0)
		...
		do
			...
			<td>
			<a href="siswa_pdf.php?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&keahkd='.$keakd.'&swkd='.$i_kd.'"><img src="'.$sumber.'/img/pdf.gif" width="16" height="16" border="0"></a>
			</td>
