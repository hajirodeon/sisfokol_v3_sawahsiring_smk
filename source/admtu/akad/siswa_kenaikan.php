...
$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&keakd=$keakd&rukd=$rukd&skkd=$skkd&swkd=$swkd";
...
if ($_POST['btnSMP6'])
	...
	if (empty($tpfkd))
		...
		$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&keakd=$keakd&rukd=$rukd";
		pekem($pesan,$ke);
		exit();
		}
		...
		for ($i=1;$i<=$limit;$i++)
			...
			if ($tcc3 != 0)
				...
				//insert
				mysql_query("INSERT INTO siswa_kelas(kd, kd_siswa, kd_tapel, kd_keahlian, ".
						"kd_kelas) VALUES ".
						"('$xyz', '$x_mskd', '$tpfkd', '$keakd', '$kelasx')");
				}
	...
	//re-direct
	$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&keakd=$keakd&rukd=$rukd&page=$page";
	xloc($ke);
	exit();
	}
...
if ($_POST['btnSMP7'])
	...
	if (empty($lulus))
		...
		$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&keakd=$keakd&rukd=$rukd&smtkd=$smtkd&skkd=$skkd&swkd=$swkd";
		pekem($pesan,$ke);
		exit();
		}
	}
...
if (empty($tapelkd))
	...
	$target = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&keakd=$keakd&rukd=$rukd";
