...
$judul = "Guru per Program Pendidikan";
...
$s = nosql($_REQUEST['s']);
$ke = "$filenya?tapelkd=$tapelkd&keakd=$keakd&jnskd=$jnskd&pelkd=$pelkd";
...
do
	...
	echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&keakd='.$keakd.'&jnskd='.$jn_kd.'">'.$jn_jns.'</option>';
	}
...
do
	...
	echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&keakd='.$keakd.'&jnskd='.$jnskd.'&pelkd='.$bskd.'">'.$bspel.'</option>';
	}
