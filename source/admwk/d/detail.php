...
$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&keahkd=$keahkd&rukd=$rukd";
...
<strong>Keahlian :</strong> '.$pro_bidang.' - '.$pro_program.',
...
if ($count != 0)
	...
	do
		...
		<td>'.$y_nama.'</td>
		<td>
		<a href="absensi.php?swkd='.$y_mskd.'&skkd='.$y_skkd.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&keahkd='.$keahkd.'"
		title="Tahun Pelajaran = '.$pel_thn1.'/'.$pel_thn2.', Kelas = '.$kel_kelas.', Ruang = '.$ru_ruang.', Keahlian = '.$pro_bidang.' - '.$pro_program.'">
		<img src="'.$sumber.'/img/preview.gif" width="16" height="16" border="0"></a>
		</td>
		<td>
		<a href="keuangan.php?swkd='.$y_mskd.'&skkd='.$y_skkd.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&keahkd='.$keahkd.'"
		title="Tahun Pelajaran = '.$pel_thn1.'/'.$pel_thn2.', Kelas = '.$kel_kelas.', Ruang = '.$ru_ruang.', Keahlian = '.$pro_bidang.' - '.$pro_program.'">
		<img src="'.$sumber.'/img/preview.gif" width="16" height="16" border="0"></a>
		</td>
		<td>
		<a href="nilai.php?swkd='.$y_mskd.'&skkd='.$y_skkd.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&keahkd='.$keahkd.'"
		title="Tahun Pelajaran = '.$pel_thn1.'/'.$pel_thn2.', Kelas = '.$kel_kelas.', Ruang = '.$ru_ruang.', Keahlian = '.$pro_bidang.' - '.$pro_program.'">
		<img src="'.$sumber.'/img/preview.gif" width="16" height="16" border="0"></a>
		</td>
		<td>
		<a href="raport.php?swkd='.$y_mskd.'&skkd='.$y_skkd.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&keahkd='.$keahkd.'"
		title="Tahun Pelajaran = '.$pel_thn1.'/'.$pel_thn2.', Kelas = '.$kel_kelas.', Ruang = '.$ru_ruang.', Keahlian = '.$pro_bidang.' - '.$pro_program.'">
