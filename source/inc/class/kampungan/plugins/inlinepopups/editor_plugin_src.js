...
// Patch openWindow, closeWindow kampungan functions

var kampungan_InlinePopupsPlugin = {
	getInfo : function() {
		return {
			longname : 'Inline Popups',
			author : 'Moxiecode Systems',
			authorurl : 'http://kampungan.moxiecode.com',
			infourl : 'http://kampungan.moxiecode.com/kampungan/docs/plugin_inlinepopups.html',
			version : kampungan.majorVersion + "." + kampungan.minorVersion
		};
	}
};

kampungan.addPlugin("inlinepopups", kampungan_InlinePopupsPlugin);

// Patch openWindow, closeWindow kampungan functions

kampungan_Engine.prototype.orgOpenWindow = kampungan_Engine.prototype.openWindow;

kampungan_Engine.prototype.openWindow = function(template, args) {
	// Does the caller support inline
	if (args['inline'] != "yes" || kampungan.isOpera || kampungan.getParam("plugins").indexOf('inlinepopups') == -1) {
	...
	var pos = kampungan.getAbsPosition(elm);
...
kampungan_Engine.prototype.orgCloseWindow = kampungan_Engine.prototype.closeWindow;

kampungan_Engine.prototype.closeWindow = function(win) {
...
kampungan_Engine.prototype.setWindowTitle = function(win_ref, title) {
...
// * * * * * kampungan_Windows classes below

// Windows handler
function kampungan_Windows() {
...
kampungan_Windows.prototype.init = function(settings) {
...
kampungan_Windows.prototype.getParam = function(name, default_value) {
	var value = null;
...
kampungan_Windows.prototype.eventDispatcher = function(e) {
...
kampungan_Windows.prototype.addEvent = function(obj, name, handler) {
	if (this.isMSIE)
...
kampungan_Windows.prototype.cancelEvent = function(e) {
	if (this.isMSIE) {
		e.returnValue = false;
		e.cancelBubble = true;
	} else
...
kampungan_Windows.prototype.parseFeatures = function(opts) {
	// Cleanup the options
...
kampungan_Windows.prototype.open = function(url, name, features) {
	this.lastSelectedWindow = this.selectedWindow;

	var win = new kampungan_Window();
	var winDiv, html = "", id;
...
kampungan_Windows.prototype.setDocumentLock = function(state) {
	if (state) {
...
kampungan_Windows.prototype.onLoad = function(name) {
...
kampungan_Windows.prototype.createFloatingIFrame = function(id_prefix, left, top, width, height, html) {
...
//	iframe.setAttribute("src", "../jscripts/kampungan/blank.htm");
...
// Window instance
function kampungan_Window() {
};

kampungan_Window.prototype.focus = function() {
...
kampungan_Window.prototype.minimize = function() {
};

kampungan_Window.prototype.maximize = function() {
	
};

kampungan_Window.prototype.startResize = function() {
	mcWindows.action = "resize";
};

kampungan_Window.prototype.startMove = function(e) {
	mcWindows.action = "move";
};

kampungan_Window.prototype.close = function() {
	if (this.frame && this.frame['kampunganPopup'])
		this.frame['kampunganPopup'].restoreSelection();
...
kampungan_Window.prototype.onMouseMove = function(e) {
...
kampungan_Window.prototype.onMouseUp = function(e) {
	mcWindows.action = "none";
};

kampungan_Window.prototype.onFocus = function(e) {
	// Gecko only handler
...
kampungan_Window.prototype.onMouseDown = function(e) {
...
// Global instance
var mcWindows = new kampungan_Windows();

// Initialize windows
mcWindows.init({
	images_path : kampungan.baseURL + "/plugins/inlinepopups/images",
	css_file : kampungan.baseURL + "/plugins/inlinepopups/css/inlinepopup.css"
});
