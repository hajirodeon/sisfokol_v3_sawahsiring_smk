...
function selectColor() {
	...
	kampunganPopup.execCommand(kampungan.getWindowArg('command'), false, color);
...
function renderColorMap() {
	var html = "";
	var inputColor = convertRGBToHex(kampungan.getWindowArg('input_color'));
	...
	html += '<tr><td colspan="18">'
		...
		+ '<tr><td>'
		+ '<img id="selectedColor" style="background-color:' + kampungan.getWindowArg('input_color') + '" border="0" src="images/spacer.gif" width="80" height="16" />'
		+ '</td><td align="right">'
		...
		+ '<div style="float: right"><input type="button" name="cancel" value="{$lang_cancel}" style="margin-top:3px" onclick="kampunganPopup.close();" id="cancel" /></div>'
		+ '</td></tr>'
		+ '</table>';
